...
multithreaded_test_path=${tazer_path}/tests/multithreaded_test
multithreaded_test=${multithreaded_test_path}/multithreaded_test.sh
...
$multithreaded_test ${node_workspace} ${data_path} ${tazer_path} ${build_dir} ${server_addr} ${server_port} ${test_id} ${shmem} ${burstbuff} ${filelock} ${ref_time} &
test_pids+=("$!")
test_id=$((test_id+NUM_NODES))

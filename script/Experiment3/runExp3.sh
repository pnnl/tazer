...
client_command="sbatch -A chess -N1 --exclude=node42 --parsable ./launch_exp.sh ${exp_type} ${tazer_server_nodes} ${TAZER_ROOT} ${TAZER_BUILD_DIR} ${WORKLOADSIM_PATH} ${scalable} ${shared} ${filemem} ${private_size} ${shared_size} ${block_size} ${H_value} ${Hb_value} ${MC_value} ${Sr_value} ${Sth_value}"
# echo $client_command

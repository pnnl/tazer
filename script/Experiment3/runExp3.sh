...
export TAZER_ROOT=/people/mutl832/tazer-paper/
export TAZER_BUILD_DIR=/people/mutl832/tazer-paper/build/
...
salloc -A ippd -N1 -d afterany:${client_task_id} ${CLOSE_SERVER} ${tazer_server_nodes} 6024
